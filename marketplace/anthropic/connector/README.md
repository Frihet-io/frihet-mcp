...
zip -r frihet-erp-1.12.0.mcpb manifest.json
...
4. Pack the bundle: `zip -r frihet-erp-1.12.0.mcpb manifest.json`
...
7. Upload `frihet-erp-1.12.0.mcpb` where the form requests a bundle.
