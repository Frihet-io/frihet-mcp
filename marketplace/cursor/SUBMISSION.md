...
| Tagline / short description | 100 chars | `AI-native ERP — invoicing, CRM, fiscal compliance (VeriFactu/TicketBAI/Facturae) via natural language.` |
...
**Long description (copy-paste ready, 827 chars):**
...
```json
{
  ...
  "homepage": "https://frihet.io/?utm_source=cursor&utm_medium=mcp_directory&utm_campaign=mcp_landgrab",
